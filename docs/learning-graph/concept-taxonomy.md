...
Twelve categories organize the 200 concepts in **Learning Knowledge Graphs**.
No category exceeds 30% of the total (the largest is 13%), and each maps to
one or more topics from the course description.
