...
description: 'An interactive intelligent textbook teaching learning knowledge graphs: how to model, build, and use concept-dependency graphs for education.'
image: img/cover.png
---
...
<figure markdown>
  ![Learning Knowledge Graphs cover](./img/cover.png){ width="100%" }
</figure>

An interactive intelligent textbook teaching learning knowledge graphs: how to model, build, and use concept-dependency graphs for education.
